...
from heracles_evaluation.tools.answer_tool import answer_tool_desc
from heracles_evaluation.tools.calculator_tool import calculator_tool
from heracles_evaluation.tools.canary_favog_tool import favog_tool
...
def get_project_root() -> Path:
    ...
    # Go up 4 levels: tests -> heracles_evaluation -> src -> project_root
...
class TestExperimentParsing:
    ...
    def test_simple_parsing(self):
        ...
        with (
            ...
            patch(
                "heracles_evaluation.experiment_definition.ExperimentConfiguration.load_questions",
                return_value=[],
            ),
        ):
